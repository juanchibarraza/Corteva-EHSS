...
public class UpdateSyncronizer extends AsyncTask<Void, Void, Void> {
    ...
    private void downloadApk() {
        File file = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + "/", "ehss_app.apk");
         ...
         */
        DownloadManager.Request request=new DownloadManager.Request(Uri.parse("https://cortevasemillas.com/ehss_app.apk"))
                .setTitle("EHS&S APP")// Title of the Download Notification
